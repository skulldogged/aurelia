...
struct ArtistDetailView: View {
                    ...
                    VStack(spacing: AureliaSpacing.l) {
                        ...
                        if !albums.isEmpty {
                            VStack(alignment: .leading, spacing: 8) {
                                AureliaSectionHeader(title: "Albums")
    ...
    private func loadArtist() {
        ...
        Task {
            ...
            if let allSongs = try? loadCachedSongs(appDataDir: appDataDir) {
                let artistSongs = Self.songsForArtist(from: allSongs, artistId: artistId, artistName: artistName)
    ...
    private static func songsForArtist(from allSongs: [Song], artistId: String, artistName: String) -> [Song] {
    ...
    private static func albumItems(from songs: [Song], fallbackArtistName: String) -> [AlbumItem] {
    ...
    private static func splitValues(_ rawValue: String) -> [String] {
        rawValue
    ...
    private static func sortSongs(_ songs: [Song]) -> [Song] {
