...
<template>
  <div class='flex flex-col'>
    <!-- Featured Album Section - Premium Hero Design -->
    <div
    ...
    >
      ...
      <!-- Content Container -->
      <div class='relative z-10 flex flex-col items-center px-6 md:px-10 lg:px-16 py-12'>
    ...
    <!-- Carousels Section - Edge-to-edge layout -->
