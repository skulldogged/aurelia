<script setup lang="ts">
  ...
  import { AlbumInfo, ArtistInfo, MusicItem } from '../types'
  ...
  const filteredAlbums = computed(() => categorizedResults.value.albums.map(r => r.item.item as AlbumInfo))
  ...
  const selectAlbum = (album: AlbumInfo) => {
