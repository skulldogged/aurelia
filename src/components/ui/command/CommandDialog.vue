...
const props = defineProps<DialogRootProps & { hideCloseButton?: boolean }>()
...
<template>
  <Dialog v-bind="forwarded">
      <DialogContent :hide-close-button="hideCloseButton" class="overflow-hidden p-0 shadow-lg bg-background-dark border-border/50">
