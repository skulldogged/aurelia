...
class LibraryViewModel(
  ...
  fun play(songId: String, container: String?, title: String, artist: String?, albumArtUrl: String? = null) {
    ...
    val durationMs = (mutableState.value.songs.firstOrNull { it.id == songId }?.duration ?: 0.0)
      .let { (it * 1000).toLong() }
