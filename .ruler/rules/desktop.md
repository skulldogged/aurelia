...
- **Logic**: Extract reusable logic to Composables (`apps/desktop/src/composables`).
- **Locations**:
  - Utilities: `apps/desktop/src/lib`
  - Shared UI: `apps/desktop/src/components/ui`
...
- **Structure**: Rust modules in `apps/desktop/src-tauri/src`. Mirror frontend models in Rust where needed.
